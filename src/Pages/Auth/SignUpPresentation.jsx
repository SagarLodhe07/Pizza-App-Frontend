...
function SignUpPresentation({ handleSignUp, handlerUserInput }) {
  return (
    <>
        ...
        <div className="flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
          <div>
            ...
            >
              ...
              />
              <path
                id="uuid-31bdf68e-d938-48b7-86ad-7ba8e8b265d3-91-89-41-240"
              ...
              />
              <path
                id="uuid-0d1d7be6-7e67-43a2-9b15-a4bbed67d7bc-92-90-42-241"
          ...
          <form className="flex flex-col w-full p-8 mt-10 bg-gray-200 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0">
            <h2 className="mb-5 font-medium text-gray-900 title-font text-lg">
              Sign Up
            </h2>
            {/* For label & Input */}
            ...
            {/* Sign Up Button */}
            <button
              className="w-full px-8 py-2 text-lg text-white bg-yellow-500 bottom-0 rounded focus:outline-none hover:bg-yellow-600"
