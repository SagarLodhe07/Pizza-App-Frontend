                    ...
                    <Link to={`/product/${item._id}`}>
                      <div className="overflow-hidden border rounded-lg border-opacity-60">
                        <img
                          ...
                          alt="Pizza Image"
                          className="object-cover object-center w-full lg:h-48 md:h-46"
                        />
                        <div className="p-6 border">
                          <h2 className="text-xs font-medium text-gray-500 title-font">
                            {item.category}
                          </h2>
                          <h1 className=" mb-3 font-medium text-gray-800 title-font">{item.productName}</h1>

                          <p className=" mb-4 text-sm text-gray-600" >{item.descripition}</p>
                          <h1>${item.price}</h1>
                        </div>
                      </div>
                    </Link>
